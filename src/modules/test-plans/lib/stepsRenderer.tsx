    ...
    <div className="overflow-hidden rounded-md border border-border/60">
                    ...
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className={cn(
                          ...
                          steps.length <= 1 && "cursor-not-allowed",
                        )}
                      >
                        <HugeiconsIcon
                          icon={Cancel01Icon}
      ...
      {editable ? (
        <button
          type="button"
          onClick={addStep}
          className="flex w-full items-center justify-center gap-1 border-t border-dashed border-border/50 bg-card/30 px-2 py-1 font-mono text-[10.5px] text-muted-foreground transition-colors hover:bg-primary/[0.04] hover:text-primary"
        >
          + add step
        </button>
      ) : null}
