      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            ...
            {showBadge ? (
              <span className="inline-flex h-4 min-w-4 items-center justify-center rounded-full border border-border/60 bg-card px-1 text-[9.5px] font-semibold leading-none tabular-nums text-muted-foreground/95">
